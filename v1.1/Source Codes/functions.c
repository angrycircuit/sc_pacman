...
void move(struct ObjectMoveInfo* object, SDL_Rect targetHitBox, int objWidth, int objHeight, struct Obstacles NoPass[])
{
    ...
    for (int i = 0; i < 5; i++) {
        if (object->posy + objHeight == NoPass[i].posy && object->posx + objHeight <= NoPass[i].posx) {
            object->posy -= object->vely;
            object->hitBox.y = object->posy;
            object->posx -= object->velx;
            object->hitBox.x = object->posx;
    ...
    for (int i = 6; i < 7; i++) {
        if (object->posx + objHeight == NoPass[i].posx && object->posy + objHeight <= NoPass[i].posy) {
            object->posy -= object->vely;
            object->hitBox.y = object->posy;
            object->posx -= object->velx;
            object->hitBox.x = object->posx;
    ...
    for (int i = 14; i < 40; i++) {
        if (object->posy + objHeight >= NoPass[i].posy && object->posy <= NoPass[i].temp && object->posx + objHeight == NoPass[i].posx) {
            object->posy -= object->vely;
            object->hitBox.y = object->posy;
            object->posx -= object->velx;
            object->hitBox.x = object->posx;
    ...
    for (int i = 41; i < 100; i++) {
        if (object->posx + objHeight >= NoPass[i].posx && object->posx <= NoPass[i].temp && object->posy + objHeight == NoPass[i].posy) {
            object->posy -= object->vely;
            object->hitBox.y = object->posy;
            object->posx -= object->velx;
            object->hitBox.x = object->posx;
