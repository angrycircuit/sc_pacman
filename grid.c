/* this is for updating the gameplay grid array */
...
void update(struct ObjectMoveInfo objectMoveInfo[CHARACTER_NUMBER], int frame) {
...
int init(struct ObjectMoveInfo* objectMoveInfo[CHARACTER_NUMBER])
{
